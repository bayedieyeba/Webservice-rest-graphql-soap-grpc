 ...
 * generated in the com.baye.exemplecustomerservice.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerById_QNAME = new QName("http://web.exemplecustomerservice.baye.com/", "customerById");
    private final static QName _CustomerByIdResponse_QNAME = new QName("http://web.exemplecustomerservice.baye.com/", "customerByIdResponse");
    private final static QName _CustomerList_QNAME = new QName("http://web.exemplecustomerservice.baye.com/", "customerList");
    private final static QName _CustomerListResponse_QNAME = new QName("http://web.exemplecustomerservice.baye.com/", "customerListResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://web.exemplecustomerservice.baye.com/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://web.exemplecustomerservice.baye.com/", "saveCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.baye.exemplecustomerservice.web
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://web.exemplecustomerservice.baye.com/", name = "customerById")
     ...
     */
    @XmlElementDecl(namespace = "http://web.exemplecustomerservice.baye.com/", name = "customerByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.exemplecustomerservice.baye.com/", name = "customerList")
     ...
     */
    @XmlElementDecl(namespace = "http://web.exemplecustomerservice.baye.com/", name = "customerListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.exemplecustomerservice.baye.com/", name = "saveCustomer")
     ...
     */
    @XmlElementDecl(namespace = "http://web.exemplecustomerservice.baye.com/", name = "saveCustomerResponse")
